...
async function createPaiement({ commande_id, montant = 0, mode_paiement = 'cash', date_paiement = null }, clientConn = null) {
  ...
  const sql = `INSERT INTO paiement (commande_id, montant, mode_paiement, date_paiement, created_at, updated_at) VALUES ($1, $2, $3, COALESCE($4, CURRENT_TIMESTAMP), CURRENT_TIMESTAMP, CURRENT_TIMESTAMP) RETURNING *`;
